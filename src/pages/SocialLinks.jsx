...
const SocialLinks = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      color: 'bg-brand-deepBlue/10 text-brand-deepBlue border-brand-deepBlue/20',
    ...
    <div className="min-h-screen pt-24 pb-16 relative z-10 flex flex-col justify-center" ref={containerRef}>
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="mb-12 text-center flex flex-col items-center">
          <AnimatedText text="Let's Connect" className="text-4xl md:text-5xl font-display font-bold text-text-main mb-4" />
            ...
            return (
              ...
              >
                <GlassCard className={`social-card flex items-center gap-6 p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-premium !bg-white/60 ${social.hoverBorder}`}>
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-text-main font-display mb-1 group-hover:text-brand-blue transition-colors">
                      {social.name}
                    </h3>
        ...
        <div className="social-cta flex justify-center">
          <GlassCard className="p-8 max-w-xl w-full text-center flex flex-col items-center !bg-white/60">
            <div className="w-16 h-16 rounded-full bg-brand-gold/10 border border-brand-gold/20 text-brand-gold flex items-center justify-center text-2xl mb-4">
              <FaEnvelope />
            </div>
            <h3 className="text-2xl font-bold text-text-main font-display mb-2">Open for collaboration</h3>
            ...
            <a
              ...
              className="inline-flex items-center justify-center px-8 py-3 bg-brand-gradient text-white rounded-full font-semibold hover:shadow-premium transition-all hover:scale-105 hover:-translate-y-1"
            >
              Say Hello
            </a>
          </GlassCard>
